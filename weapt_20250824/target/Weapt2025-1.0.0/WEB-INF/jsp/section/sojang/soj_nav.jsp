...
<div id="wrap">
            ...
            <ul class="tree" id="aside_ul">
                ...
                <li id="soj05">
                    ...
                    <ul class="tree_nav">
                        ...
                        <li id="soj05040"><a href="soj05040.jsp">전산회사등록</a></li>
                        <li id="soj05050"><a href="soj05050.jsp">관리자등록</a></li>
                        <li id="soj05060"><a href="soj05060.jsp">관리회사등록</a></li>
                        <li id="soj05070"><a href="soj05070.jsp">관리소등록</a></li>
                        <li id="soj05080"><a href="soj05080.jsp">관리소현황</a></li>
                        <li id="soj05090"><a href="soj05090.jsp">부서직책설정(공통)</a></li>
                        <li id="soj05100"><a href="soj05100.jsp">하드용량관리</a></li>
                        <li id="soj05110"><a href="soj05110.jsp">관리자메뉴얼</a></li>
                        <li id="soj05120"><a href="soj05120.jsp">수정사항</a></li>
                    </ul>                           
                </li>
                <li id="soj06">
                ...
                <li id="soj07">
                    ...
                    <ul class="tree_nav">
                        ...
                        <li id="soj07020"><a href="soj07020.jsp">그룹별메뉴관리</a></li>
                        <li id="soj07030"><a href="soj07030.jsp">세부그룹별메뉴관리</a></li>
                        <li id="soj07040"><a href="soj07040.jsp">공통코드관리</a></li>
                        <li id="soj07050"><a href="soj07050.jsp">Conversion 관리</a></li>
                    </ul>
                </li>
            </ul>
        </div>
 ...
 <script>
    ...
    aside_ul.addEventListener('click', (e) => {
        ...
        location.href =  ctx + "/goMenu?pg=" + menuId + "/" + pg.id

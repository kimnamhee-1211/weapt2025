...
<%@ include file = "soj_nav.jsp" %>
    ...
    <script>
        ...
        const search_subUsergroupId = document.querySelector("#search_subUsergroupId");	//조회 컴포넌트 : 세부권한그룹
        ...
        //권한그룹 선택 시 세부권한그룹 변경
        search_usergroupId.addEventListener('change',() => {
            let item = null;
            if(search_usergroupId.value == "400"){
                item = "128";
            }
            if(search_usergroupId.value == "500"){
                item = "127";
            }

...
<%@ include file = "../../popup/pop_addr1.jsp" %>
            ...
            <div class="layer_bg" id="grid1_popup">
                <div class="popup" style="width:620px;">
                    ...
                    <div style="padding: 15px;">
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="width: 200px;"><input type="text" id="" name="COMP_CODE" oninput="inputNumFormat(this)"></td> <!-- 101부터 증가-->
                                <th style="width: 100px;">등록일</th>
                                <td style="width: 200px;"><input type="text" id="" name="REGI_DAY" data-format="date" oninput="inputDateFormat(this)" placeholder="YYYY-MM-DD" maxlength="10"></td>
                            </tr>
                            <tr>
                                <th>*관리회사명</th>
                            ...
                            <tr>
                                ...
                                <th>대표자번호</th>
                                <td><input type="text" id="" name="CEO_HP" oninput="inputTelFormat(this)" placeholder="000-000-0000" maxlength="11"></td>
                            </tr>
                            <tr>
                                <th>업태</th>
                            ...
                            <tr>
                                <td colspan='3'><input type="text" id="" name="ADDR1" ></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th>해지일</th>
                                <td><input type="text" id="input_offDay" name="OFF_DAY" data-format="date" oninput="inputDateFormat(this)" placeholder="YYYY-MM-DD" maxlength="10"></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="pop_btn">
                        ...
                        <button id="close_btn1" onclick="popupClose(write_popup)">닫기</button>
                    </div>
                </div>
                <!-- 팝업끝-->
            </div>

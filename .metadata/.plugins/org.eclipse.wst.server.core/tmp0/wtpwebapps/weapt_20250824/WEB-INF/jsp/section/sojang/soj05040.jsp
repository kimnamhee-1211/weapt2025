                        ...
                        <div style="padding: 15px;">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 200px;"><input type="text" id="" name="MGMCOMP_CODE" oninput="inputNumFormat(this)"></td> <!-- 101부터 증가-->
                                ...
                                <tr>
                                    ...
                                    <th>해지일</th>
                                    <td><input type="text" id="input_regiDay" name="REGI_DAY" data-format="date" oninput="inputDateFormat(this)" placeholder="YYYY-MM-DD" maxlength="10"></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
